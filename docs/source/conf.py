# -*- coding: utf-8 -*-
#
# DDdocs documentation build configuration file, created by
# sphinx-quickstart on Thu Dec  4 21:20:23 2014.
#
...
# Defines that the autodoc has to follow the same order than the source code
...
texinfo_documents = [
  ('index', 'DDdocs', u'Solcore documentation',
   u'Quantum Photovoltaics Group, Imperial College London',
   'Solcore', 'One line description of project.',
   'Miscellaneous'),
]
